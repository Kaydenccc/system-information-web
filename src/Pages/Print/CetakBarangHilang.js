...
import BarangHilangPrint from './ComponentToPrint/BarangHilangPrint';

const CetakBarangHilang = () => {
  ...
  return (
    <div className="pb-20 h-screen w-full   !scrollbar-thin !scrollbar-track-transparent scrollbar-thumb-slate-400/30 scroll-smooth">
      <div className="px-6  py-6">
        <BarangHilangPrint ref={componentRef} />
      </div>
...
export default CetakBarangHilang;
