...
import JadwalPengajarPrint from './ComponentToPrint/JadwalPengajarPrint';

const CetakJadwalPengajar = () => {
  ...
  return (
    <div className="pb-20 h-screen !scrollbar-thin !scrollbar-track-transparent scrollbar-thumb-slate-400/30 scroll-smooth">
      <div className="px-6 py-6">
        <JadwalPengajarPrint ref={componentRef} />
      </div>
...
export default CetakJadwalPengajar;
