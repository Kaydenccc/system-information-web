...
import PeminjamanPrint from './ComponentToPrint/PeminjamanPrint';

const CetakPeminjaman = (Children, Comp) => {
  ...
  return (
    <div className="pb-20 h-screen !scrollbar-thin !scrollbar-track-transparent scrollbar-thumb-slate-400/30 scroll-smooth">
      <div className="px-6 py-6">
        <PeminjamanPrint ref={componentRef} />
      </div>
...
export default CetakPeminjaman;
