...
import PengembalianPrint from './ComponentToPrint/PengemabalianPrint';

const CetakPengembalian = () => {
  ...
  return (
    <div className="pb-20 h-screen !scrollbar-thin !scrollbar-track-transparent scrollbar-thumb-slate-400/30 scroll-smooth">
      <div className="px-6 py-6">
        <PengembalianPrint ref={componentRef} />
      </div>
...
export default CetakPengembalian;
