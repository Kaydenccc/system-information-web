...
const JadwalPengajarPrint = React.forwardRef((_, ref) => {
  return (
    <article className=" h-full w-full" ref={ref}>
      ...
      <main className="flex justify-start overflow-x-auto flex-col items-start py-4 ">
        <h1 className="self-center uppercase text-xl font-bold">Laporan Jadwal Pengajar</h1>
...
export default JadwalPengajarPrint;
