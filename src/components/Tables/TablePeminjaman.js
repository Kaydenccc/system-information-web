      ...
      <tbody className="bg-slate-50 dark:bg-gray-800 client">
        {dataPengajuan.map((data, i) => (
          <tr key={i} className="cursor-pointer">
            ...
            <td className="text-start border-b relative border-slate-300 dark:border-slate-600 pl-6 py-2">{data.status}</td>
            <td className="border-b relative py-2 pl-6  border-slate-300 dark:border-slate-600">{data.name}</td>
            <td className="border-b text-center relative py-2   border-slate-300 dark:border-slate-600">{data.jumlah}</td>
