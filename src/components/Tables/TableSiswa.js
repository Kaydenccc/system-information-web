    ...
    <table className="border-collapse md:border-separate table-auto w-full  md:w-full">
      <thead>
        <tr>
          ...
          <th className="text-center md:text-start border-b border-slate-300 dark:border-slate-500 pb-2 md:pl-6 text-gray-800 dark:text-slate-300">Kelas</th>
          <th className="text-end border-b border-slate-300 dark:border-slate-500 pr-6 md:pr-0 md:pl-6 md:text-start pb-2 text-gray-800 dark:text-slate-300">Angkatan</th>
      ...
      <tbody className="bg-slate-50 dark:bg-gray-800 client">
        {dataSiswa.map((alat, i) => (
          <tr key={i} className="cursor-pointer">
            <td className="border-b relative py-2 md:pl-6 hidden md:table-cell border-slate-300 dark:border-slate-600">{i + 1}</td>
            <td className="border-b relative py-2 pl-6  border-slate-300 dark:border-slate-600">{alat.name}</td>
            <td className="text-center md:text-start border-b relative border-slate-300 dark:border-slate-600 md:pl-6 pb-2">{alat.class}</td>
            <td className="text-end md:text-start border-b relative border-slate-300 dark:border-slate-600 md:pl-6 pr-6 md:pr-0 pb-2">{alat.angkatan}</td>
